...
const TodoList = () => {
    ...
    const updateTask = async () => {
        ...
        try {
            const response = await axios.put(`${process.env.REACT_APP_BACKEND_URL}/tasks/${editTaskId}`, { title: editTaskTitle });
    ...
    const deleteTask = async (id) => {
        try {
            const response = await axios.delete(`${process.env.REACT_APP_BACKEND_URL}/tasks/${id}`);
    ...
    const toggleComplete = async (id, completed) => {
        try {
            const response = await axios.put(`${process.env.REACT_APP_BACKEND_URL}/tasks/${id}`, { completed: !completed });
